    ...
    for aug in augments:
        ...
        for epoch in tqdm(range(epochs)):
            ...
            if val_epoch_accuracy > val_acc:
                ...
                torch.save(model.state_dict(), f"./best_ckp_paper_{aug}.pth")
        end = time.time()
        print((end-start)/60, 'minutes')
        torch.save(model.state_dict(), f"./last_ckp_paper_{aug}.pth")
        # accuracy plots
        ...
        plt.ylabel('Accuracy')
        plt.legend()
        plt.savefig('./accuracy_paper_{}.png'.format(aug))
        # loss plots
        plt.figure(figsize=(10, 7))
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig('./loss_paper_{}.png'.format(aug))
